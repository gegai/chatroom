...
(function () {
    ...
    (function () {
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            getTabIndex: CKEDITOR.env.ie ? function () {
                var a = this.$.tabIndex;
                a === 0 && (!CKEDITOR.dtd.$tabIndex[this.getName()] && parseInt(this.getAttribute("tabindex"), 10) !== 0) &&
                (a = -1);
                return a
            ...
            getDocumentPosition: function (a) {
                var b = 0,
                    c = 0, f = this.getDocument(), j = f.getBody(), g = f.$.compatMode == "BackCompat";
                if (document.documentElement.getBoundingClientRect) {
                    var m = this.$.getBoundingClientRect(), y = f.$.documentElement, s = y.clientTop || j.$.clientTop || 0, w = y.clientLeft || j.$.clientLeft || 0, q = true;
                    if (CKEDITOR.env.ie) {
            ...
            getDirection: function (a) {
                return a ? this.getComputedStyle("direction") || this.getDirection() || this.getParent() && this.getParent().getDirection(1) || this.getDocument().$.dir || "ltr" : this.getStyle("direction") ||
            ...
            findOne: function (b) {
                var c = a(this), b = this.$.querySelector(f(this,
                    b));
                c();
    ...
    (function () {
        ...
        function r(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles,
                f, p, i, l;
    ...
    (function () {
        ...
        var m = CKEDITOR.dom.walker.bogus(), y = /(^|<body\b[^>]*>)\s*<(p|div|address|h\d|center|pre)[^>]*>\s*(?:<br[^>]*>|&nbsp;|\u00A0|&#160;)?\s*(:?<\/\2>)?\s*(?=$|<\/body>)/gi, s = CKEDITOR.dom.walker.whitespaces(true),
            ...
            b.on("mode", function () {
                ...
                if (a && a.isInline()) {
                    ...
                    if (d)if (c = this.ui.space(this.elementMode == CKEDITOR.ELEMENT_MODE_INLINE ? "top" : "contents")) {
                        var e = CKEDITOR.tools.getNextId(), d = CKEDITOR.dom.element.createFromHtml('<span id="' + e + '" class="cke_voice_label">' +
                            d + "</span>");
                        c.append(d);
        ...
        var q = function () {
            ...
            function d(b, c) {
                var e = [], f = b.getChildren(), l = f.count(), p, h = 0, g = r[c], n = !b.is(r.$inline) ||
                    b.is("br");
                for (n && e.push(" "); h < l; h++) {
                    p = f.getItem(h);
            ...
            return function (g,
                             n, k) {
                var q = g.editor, v = q.getSelection().getRanges()[0], G = false;
                ...
                if (!v.checkReadOnly()) {
                    ...
                    x =
                        new CKEDITOR.dom.elementPath(q.startContainer);
                    ...
                    if (B) {
                        ...
                        for (p(x, t); B < x.length; B++) {
                            ...
                            if (D)G = B > 0; else {
                                D = t.startPath();
                                if (!E.isBlock && h(n.editor, D.block, D.blockLimit) && (Q = n.editor.activeEnterMode != CKEDITOR.ENTER_BR && n.editor.config.autoParagraph !==
                                ...
                                if (a.labelLayout != "horizontal")e.push('<label class="cke_dialog_ui_labeled_label' + g + '" ', ' id="' + c.labelId + '"', c.inputId ? ' for="' + c.inputId + '"' : "", (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">", a.label, "</label>", '<div class="cke_dialog_ui_labeled_content"', a.controlStyle ? ' style="' + a.controlStyle + '"' : "", ' role="presentation">', f.call(this, b, a), "</div>"); else {
                                    g = {
                                        type: "hbox", widths: a.widths, padding: 0, children: [{
                                            ...
                                            g + '" id="' + c.labelId + '" for="' + c.inputId + '"' + (a.labelStyle ? ' style="' + a.labelStyle + '"' : "") + ">" + CKEDITOR.tools.htmlEncode(a.label) + "</label>"
                                        }, {
                                            type: "html",
    ...
    (function () {
        ...
        CKEDITOR.dialog = function (a, b) {
            ...
            this.on("show", function () {
                u.on("keydown", d, this);
                if (CKEDITOR.env.gecko)u.on("keypress",
                    g, this)
            });
            ...
            this.on("show", function () {
                ...
                a.config.dialog_startupFocusTab && b ? (k._.tabBarMode = !0, k._.tabs[k._.currentTabId][0].focus(), k._.currentFocusIndex = -1) : this._.hasFocus || (this._.currentFocusIndex = b ? -1 : this._.focusList.length -
                1, f.onFocus ? (b = f.onFocus.call(this)) && b.focus() : e(1))
        ...
        CKEDITOR.dialog.prototype = {
            destroy: function () {
                ...
                return function (a, b) {
                    if (!this._.contentSize || !(this._.contentSize.width ==
            ...
            setupContent: function () {
                ...
                if (!a.requiredContent || this._.editor.filter.check(a.requiredContent)) {
                    ...
                    c = CKEDITOR.dom.element.createFromHtml(['<a class="cke_dialog_tab"', 0 < this._.pageCount ? " cke_last" : "cke_first", c, a.hidden ?
                        ' style="display:none"' : "", ' id="', d, '"', e.gecko && !e.hc ? "" : ' href="javascript:void(0)"', ' tabIndex="-1" hidefocus="true" role="tab">', a.label, "</a>"].join(""));
                    ...
                    a.accessKey && (O(this, this, "CTRL+" + a.accessKey, Y, Z), this._.accessKeyMap["CTRL+" + a.accessKey] =
                        a.id)
                }
                ...
                uiElement: function (a, b, c, e, d, g, f) {
                    if (!(4 > arguments.length)) {
                        var h = (e.call ? e(b) : e) || "div",
                            m = ["<", h, " "], l = (d && d.call ? d(b) : d) || {}, i = (g && g.call ? g(b) : g) || {}, o = (f && f.call ? f.call(this, a, b) : f) || "", j = this.domId = i.id || CKEDITOR.tools.getNextId() + "_uiElement";
                        ...
                        this.accessKeyUp && (this.accessKeyDown &&
                        b.accessKey) && O(this, a, "CTRL+" + b.accessKey);
                        var p = this;
                        a.on("load", function () {
                        ...
                        CKEDITOR.tools.extend(this, b);
                        this.keyboardFocusable && (this.tabIndex = b.tabIndex || 0, this.focusIndex = a._.focusList.push(this) -
                            1, this.on("focus", function () {
        ...
        (function () {
            var a = /^([a]|[^a])+$/,
                b = /^\d*$/, c = /^\d*(?:\.\d+)?$/, e = /^(((\d*(\.\d+))|(\d*))(px|\%)?)?$/, d = /^(((\d*(\.\d+))|(\d*))(px|em|ex|in|cm|mm|pt|pc|\%)?)?$/i, g = /^(\s*[\w-]+\s*:\s*[^:;]+(?:;|$))*$/;
